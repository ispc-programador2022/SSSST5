...
for auto in autos:
    ...
    precio = auto.find_element("xpath",'.//div//span[@data-aut-id="itemPrice"]').text
    lista_precios.append(precio)
    #print (precio)
    # Descripción de cada anuncio
    descripcion = auto.find_element("xpath",'.//div//span[@data-aut-id="itemTitle"]').text
    lista_descripcion.append(descripcion)
    #print (descripcion)
    año_km=auto.find_element("xpath",'.//div//span[@data-aut-id="itemDetails"]').text
